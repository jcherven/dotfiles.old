...
color11="ff/9b/f1" # Base 0A - Bright Yellow
color12="09/8f/99" # Base 0D - Bright Blue
color13="21/bb/c7" # Base 0E - Bright Magenta
color14=$color06 # Base 0C - Bright Cyan
color15=$color00 # Base 07 - Bright White
color16="ff/a5/00" # Base 09
color17="b0/30/60" # Base 0F
color18="29/2b/2e" # Base 01
...
# Bold: "ef/ff/ff"
# Cursor: "b1/95/1d"
# Cursor text: "29/2b/2e"
# Cursor guide: "94/37/ff" low opacity
# Links: "2d/95/74"
# Selection: "5d/4d/7a"
# Selected Text: "b2/b2/b2"
# Badge: "ce/53/7a"
# Tab Color: "80/6a/a8"
# Underline color: ""
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Ph 292b2e # background
  put_template_custom Pi 806aa8 # bold color
  put_template_custom Pj 404374 # selection color
  put_template_custom Pk a3a3a3 # selected text color
  put_template_custom Pl b1951d # cursor
  put_template_custom Pm 292b2e # cursor text
else
